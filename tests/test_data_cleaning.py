...
class MockSchemaAlignmentConfig:
    table_schemas: Dict[str, MockTableSchema] = field(
        default_factory=lambda: {
            "postings": MockTableSchema(dtypes={"job_id": "Int64", "company_id": "Int64"}),
            "companies": MockTableSchema(dtypes={"company_id": "Int64", "name": "string"}),
            "salaries": MockTableSchema(dtypes={"job_id": "Int64", "med_salary": "float64"}),
            "industries": MockTableSchema(dtypes={"industry_id": "Int64", "industry_name": "string"}),
            "job_skills": MockTableSchema(dtypes={"job_id": "Int64", "skill_id": "Int64"}),
        }
    )
...
def test_detailed_report_and_summary_metrics(sample_validated_data, mock_cleaner_config):
    ...
    # Detailed table report validation
    ...
    assert summary.tables_processed == 4
    assert summary.tables_passed == 4
